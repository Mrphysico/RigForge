...
export const CheckoutModal: React.FC<CheckoutModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
      ...
      <div className="relative w-full max-w-2xl bg-zinc-950 border border-zinc-800 rounded-3xl shadow-2xl overflow-hidden z-10 flex flex-col max-h-[92vh]">
        {/* Neon top accent */}
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-white tracking-tight">
                {step === 4 ? 'Order Placed & Confirmation' : 'UPI QR Payment Gateway'}
              </h2>
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {step === 1 && (
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-cyan-400">Pan-India Express Delivery</span>
              </div>

              {/* Items List */}
              <div className="max-h-56 overflow-y-auto divide-y divide-zinc-850 rounded-xl border border-zinc-850 bg-zinc-900/40 p-2">
                {items.length === 0 ? (
                    ...
                    <div key={item.product.id} className="py-2.5 px-3 flex items-center justify-between gap-3 text-xs">
                      <div className="flex items-center gap-3 min-w-0">
                        <img
                          ...
                          className="w-10 h-10 rounded-lg object-cover border border-zinc-800 bg-zinc-950 flex-shrink-0"
                        />
                      ...
                      <div className="font-mono font-bold text-cyan-400 flex-shrink-0">
              ...
              {/* Bill Details */}
              <div className="p-4 rounded-2xl bg-zinc-900/70 border border-zinc-800 space-y-2 text-xs">
                ...
                <div className="pt-2 border-t border-zinc-800 flex justify-between text-base font-extrabold text-white">
                  ...
                  <span className="font-mono text-cyan-400 text-lg">{formatINR(grandTotal)}</span>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="text-center space-y-1">
                ...
                <p className="text-xs text-zinc-400">
                  Scan using any UPI app on your phone to transfer <strong className="text-cyan-400 font-mono">{formatINR(grandTotal)}</strong>
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center">
                ...
                <div className="sm:col-span-6 flex flex-col items-center justify-center">
                  <div className="relative p-3 rounded-2xl bg-white shadow-glow-cyan border-2 border-cyan-400 group">
                    <img
                    ...
                    />
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-2.5 py-0.5 rounded-full bg-zinc-950 text-cyan-400 text-[10px] font-mono font-bold border border-cyan-500 shadow-md">
                ...
                <div className="sm:col-span-6 space-y-3.5">
                  ...
                  <div className="p-3.5 rounded-xl bg-zinc-900 border border-zinc-800 space-y-2">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 rounded-md text-xs font-semibold bg-zinc-800 hover:bg-cyan-500 hover:text-zinc-950 text-zinc-300 flex items-center gap-1 transition-colors"
                      >
                        {copiedUpi ? (
                          <>
                  ...
                  <div>
                    <span className="text-[11px] font-mono text-zinc-400 block mb-2">Accepted Payment Apps:</span>
                    <div className="grid grid-cols-4 gap-2 text-center text-[10px] font-bold text-zinc-200">
                      <div className="p-1.5 rounded-lg bg-zinc-900 border border-zinc-800">GPay</div>
                      <div className="p-1.5 rounded-lg bg-zinc-900 border border-zinc-800">PhonePe</div>
                      <div className="p-1.5 rounded-lg bg-zinc-900 border border-zinc-800">Paytm</div>
                      <div className="p-1.5 rounded-lg bg-zinc-900 border border-zinc-800">Navi</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="py-3 px-4 rounded-xl text-xs font-semibold bg-zinc-900 hover:bg-zinc-800 text-zinc-300 border border-zinc-800 flex items-center justify-center gap-2 transition-colors"
                >
                ...
                <button
                  type="button"
                  onClick={() => setStep(3)}
                  className="flex-1 py-3.5 px-4 rounded-xl font-bold text-xs uppercase tracking-wider bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-zinc-950 flex items-center justify-center gap-2 shadow-glow-cyan transition-all active:scale-[0.99]"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full py-3 px-4 text-base font-mono bg-zinc-900 text-white placeholder-zinc-500 rounded-xl border border-zinc-800 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 tracking-widest text-center"
                    autoFocus
                  />
                ...
                <div>
                  ...
                  <div className="relative border-2 border-dashed border-zinc-800 hover:border-zinc-700 rounded-xl p-4 text-center cursor-pointer transition-colors bg-zinc-900/30">
                    <input
                      type="file"
                      accept="image/*"
                ...
                <div className="p-3.5 rounded-xl bg-zinc-900/60 border border-zinc-850 text-xs space-y-1.5 text-zinc-400">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono font-bold text-cyan-400">{formatINR(grandTotal)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>UPI ID:</span>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-3.5 px-4 rounded-xl font-bold text-xs uppercase tracking-wider bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-zinc-950 flex items-center justify-center gap-2 shadow-glow-cyan transition-all active:scale-[0.99] disabled:opacity-50"
                >
                  {isSubmitting ? (
          ...
          {step === 4 && (
            <div className="py-6 flex flex-col items-center justify-center text-center space-y-4 animate-fadeIn">
              ...
              {/* Order Tracking Card */}
              <div className="w-full bg-zinc-900/90 rounded-2xl p-5 border border-zinc-800 text-left text-xs space-y-2.5 my-2">
                <div className="flex justify-between items-center pb-2 border-b border-zinc-800">
                  <span className="text-zinc-400">Order Tracking ID:</span>
                  <span className="font-mono font-extrabold text-cyan-400 text-sm">{placedOrderId}</span>
                </div>
                <div className="flex justify-between">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-zinc-950 shadow-glow-cyan transition-all"
              >
        ...
        {/* Security footer */}
        <div className="p-3.5 border-t border-zinc-850 bg-zinc-900/40 flex items-center justify-center gap-2 text-[11px] text-zinc-500 font-mono">

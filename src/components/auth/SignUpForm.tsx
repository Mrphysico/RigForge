    ...
    <div className="space-y-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-9 py-2.5 text-xs bg-[#131d38] text-white placeholder-slate-500 rounded-xl border border-[#26365a] focus:outline-none focus:border-[#FCA311] focus:ring-1 focus:ring-[#FCA311] transition-colors"
              />
              <button
                type="button"
        ...
        <button
          type="submit"
          disabled={loading || googleLoading}
          className="w-full py-3 px-4 rounded-xl font-bold text-xs uppercase tracking-wider bg-[#FCA311] hover:bg-[#e59200] text-black flex items-center justify-center gap-2 shadow-glow-orange transition-all active:scale-[0.99] disabled:opacity-50 mt-2 cursor-pointer"
        >
          {loading ? (

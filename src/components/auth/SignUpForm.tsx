    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-xs bg-[#050a14] text-white placeholder-slate-500 rounded-xl border border-[#1e2d4f] focus:outline-none focus:border-[#ff1e2d] transition-colors"
            />
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-8 py-2 text-xs bg-[#050a14] text-white placeholder-slate-500 rounded-xl border border-[#1e2d4f] focus:outline-none focus:border-[#ff1e2d] transition-colors"
              />
              <button
                type="button"
        ...
        <button
          ...
          className="w-full py-3 px-4 rounded-xl font-bold text-xs uppercase tracking-wider bg-[#ff1e2d] hover:bg-[#e50914] text-white flex items-center justify-center gap-2 shadow-glow-red transition-all active:scale-[0.99] disabled:opacity-50 cursor-pointer mt-2"
        >
          {loading ? (
      ...
      <div className="text-center text-xs text-slate-400 pt-1">
        ...
        <button
          ...
          className="text-[#ff1e2d] hover:underline font-bold ml-1 cursor-pointer"
        >
          Sign In &gt;
        </button>
      </div>
